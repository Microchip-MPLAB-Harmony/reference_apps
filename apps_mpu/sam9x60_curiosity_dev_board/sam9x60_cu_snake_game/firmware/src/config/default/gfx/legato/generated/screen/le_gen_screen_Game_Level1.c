...
leButtonWidget* Game_Level1_ButtonWidget1;
...
leResult screenShow_Game_Level1(void)
{
    ...
    Game_Level1_Game_Won_level1->fn->setScheme(Game_Level1_Game_Won_level1, &SnakePart_Scheme_GREEN);
    ...
    Game_Level1_ButtonWidget1 = leButtonWidget_New();
    Game_Level1_ButtonWidget1->fn->setPosition(Game_Level1_ButtonWidget1, 16, 113);
    Game_Level1_ButtonWidget1->fn->setSize(Game_Level1_ButtonWidget1, 667, 334);
    Game_Level1_ButtonWidget1->fn->setBackgroundType(Game_Level1_ButtonWidget1, LE_WIDGET_BACKGROUND_NONE);
    Game_Level1_ButtonWidget1->fn->setBorderType(Game_Level1_ButtonWidget1, LE_WIDGET_BORDER_NONE);
    root0->fn->addChild(root0, (leWidget*)Game_Level1_ButtonWidget1);

    leAddRootWidget(root0, 0);
    leSetLayerColorMode(0, LE_COLOR_MODE_RGB_565);

    Game_Level1_OnShow(); // raise event
...
void screenHide_Game_Level1(void)
{
    ...
    Game_Level1_ButtonWidget1 = NULL;
