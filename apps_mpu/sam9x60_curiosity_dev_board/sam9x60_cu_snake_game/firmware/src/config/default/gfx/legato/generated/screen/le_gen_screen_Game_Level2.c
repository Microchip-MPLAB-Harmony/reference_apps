...
leButtonWidget* Game_Level2_ButtonWidget2;
...
leResult screenShow_Game_Level2(void)
{
    ...
    Game_Level2_Game_Won_level2->fn->setScheme(Game_Level2_Game_Won_level2, &SnakePart_Scheme_GREEN);
    ...
    Game_Level2_ButtonWidget2 = leButtonWidget_New();
    Game_Level2_ButtonWidget2->fn->setPosition(Game_Level2_ButtonWidget2, 15, 115);
    Game_Level2_ButtonWidget2->fn->setSize(Game_Level2_ButtonWidget2, 684, 347);
    Game_Level2_ButtonWidget2->fn->setBackgroundType(Game_Level2_ButtonWidget2, LE_WIDGET_BACKGROUND_NONE);
    Game_Level2_ButtonWidget2->fn->setBorderType(Game_Level2_ButtonWidget2, LE_WIDGET_BORDER_NONE);
    root0->fn->addChild(root0, (leWidget*)Game_Level2_ButtonWidget2);

    leAddRootWidget(root0, 0);
    leSetLayerColorMode(0, LE_COLOR_MODE_RGB_565);

    Game_Level2_OnShow(); // raise event
...
void screenHide_Game_Level2(void)
{
    ...
    Game_Level2_ButtonWidget2 = NULL;
