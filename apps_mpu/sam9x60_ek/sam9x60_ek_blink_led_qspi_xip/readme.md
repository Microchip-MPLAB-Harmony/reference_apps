...
- Select Bootstrap for Categories and select the `Use Bootstrap` checkbox. For `bootstrap file` -> select the at91bootstrap elf file from [here](./firmware/sam9x60_ek.X)- Click on Apply and OK.  <br>
...
## Running the pre-built harmony application from QSPI flash memory:
