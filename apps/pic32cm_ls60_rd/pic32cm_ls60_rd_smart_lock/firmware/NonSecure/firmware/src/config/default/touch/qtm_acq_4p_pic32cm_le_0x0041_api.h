/*******************************************************************************
  ...
  File Name:
    qtm_acq_4p_pic32cm_le_0x0041_api.h
...
#ifndef __TOUCH_API_PIC32CM_4P_H__
#define __TOUCH_API_PIC32CM_4P_H__
...
typedef struct
{
  uint16_t num_sensor_nodes;            /* Number of sensor nodes - multiple of 4 */
...
typedef struct
{
  ...
  qtm_acq_4p_pic32cm_config_t (*qtm_acq_node_config);
...
#endif    /* __TOUCH_API_PIC32CM_4P_H__ */
