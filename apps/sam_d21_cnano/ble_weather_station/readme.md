...
Refer [Project Manifest](./firmware/src/config/samd21_cnano/harmony-manifest-success.yml) present in harmony-manifest-success.yml under the project folder *firmware/src/config/{configurtion name}*  
