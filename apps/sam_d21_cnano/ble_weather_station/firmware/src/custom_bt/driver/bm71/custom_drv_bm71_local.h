/*******************************************************************************
  BM71 Bluetooth Static Driver local header file.

  Company:
    Microchip Technology Inc.

  File Name:
    custom_drv_bm71_local.h
...
********************************************************************/
#ifndef CUSTOM_DRV_BM71_LOCAL_H
#define CUSTOM_DRV_BM71_LOCAL_H
