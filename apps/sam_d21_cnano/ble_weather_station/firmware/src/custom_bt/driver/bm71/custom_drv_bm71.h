/*******************************************************************************
  BM71 Bluetooth Static Driver header file
...
#ifndef CUSTOM_DRV_BM71_H
#define CUSTOM_DRV_BM71_H
...
void DRV_BM71_CustomSendDataOverBLE(const DRV_HANDLE handle, uint8_t* bytes, uint16_t size, uint8_t char_handle);
// *****************************************************************************
