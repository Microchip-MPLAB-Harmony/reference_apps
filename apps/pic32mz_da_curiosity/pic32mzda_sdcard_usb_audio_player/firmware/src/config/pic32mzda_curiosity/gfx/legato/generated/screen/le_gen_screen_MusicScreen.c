...
leResult screenShow_MusicScreen(void)
{
    ...
    MusicScreen_GradientWidget1->fn->setPosition(MusicScreen_GradientWidget1, 0, 0);
    MusicScreen_GradientWidget1->fn->setSize(MusicScreen_GradientWidget1, 480, 272);
    ...
    MusicScreen_PlayPausebutton->fn->setPosition(MusicScreen_PlayPausebutton, 163, 201);
    ...
    MusicScreen_ButtonWidget0->fn->setPosition(MusicScreen_ButtonWidget0, 286, 202);
    ...
    MusicScreen_RectangleWidget1->fn->setPosition(MusicScreen_RectangleWidget1, 56, 175);
    MusicScreen_RectangleWidget1->fn->setSize(MusicScreen_RectangleWidget1, 330, 23);
    ...
    MusicScreen_RectangleWidget0->fn->setPosition(MusicScreen_RectangleWidget0, 56, 175);
    MusicScreen_RectangleWidget0->fn->setSize(MusicScreen_RectangleWidget0, 1, 23);
    ...
    MusicScreen_LabelWidget0->fn->setPosition(MusicScreen_LabelWidget0, 14, 180);
    MusicScreen_LabelWidget0->fn->setSize(MusicScreen_LabelWidget0, 32, 15);
    ...
    MusicScreen_LabelWidget1->fn->setPosition(MusicScreen_LabelWidget1, 393, 177);
    ...
    MusicScreen_ButtonWidget1->fn->setPosition(MusicScreen_ButtonWidget1, 16, 198);
    MusicScreen_ButtonWidget1->fn->setSize(MusicScreen_ButtonWidget1, 135, 74);
    ...
    MusicScreen_ListWheelWidget0->fn->setPosition(MusicScreen_ListWheelWidget0, 16, 51);
    MusicScreen_ListWheelWidget0->fn->setSize(MusicScreen_ListWheelWidget0, 407, 119);
    ...
    MusicScreen_ListWheelWidget0->fn->setIndicatorArea(MusicScreen_ListWheelWidget0, 15);
    MusicScreen_ListWheelWidget0->fn->setIndicatorFill(MusicScreen_ListWheelWidget0, LE_LISTWHEEL_INDICATOR_FILL_GRADIENT);
    ...
    MusicScreen_LabelWidget4->fn->setPosition(MusicScreen_LabelWidget4, 10, 89);
    MusicScreen_LabelWidget4->fn->setSize(MusicScreen_LabelWidget4, 400, 41);
