...
Refer [Project Manifest](./firmware/src/config/sam_c21n_xpro/harmony-manifest-success.yml) present in harmony-manifest-success.yml under the project folder *firmware/src/config/{configurtion name}*  
