...
// USER_WORD_2
#pragma config IDAU_AS = 0x40 // Enter Hexadecimal value
#pragma config IDAU_ANSC = 0x10 // Enter Hexadecimal value
#pragma config IDAU_DS = 0x40 // Enter Hexadecimal value

// USER_WORD_3
#pragma config IDAU_RS = 0x80 // Enter Hexadecimal value
...
// USER_WORD_8
#pragma config BOOTROM_USERCRC = 0x4E75A269 // Enter Hexadecimal value
