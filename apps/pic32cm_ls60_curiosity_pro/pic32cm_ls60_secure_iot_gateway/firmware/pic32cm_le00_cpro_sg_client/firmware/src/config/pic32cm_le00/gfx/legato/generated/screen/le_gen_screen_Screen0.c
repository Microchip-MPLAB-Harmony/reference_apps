...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_nonsecure->fn->setSize(Screen0_nonsecure, 20, 25);
    ...
    Screen0_nonsecure->fn->setImage(Screen0_nonsecure, (leImage*)&nonsecure);
    root0->fn->addChild(root0, (leWidget*)Screen0_nonsecure);

    Screen0_secure = leImageWidget_New();
    Screen0_secure->fn->setPosition(Screen0_secure, 73, 0);
    Screen0_secure->fn->setSize(Screen0_secure, 20, 25);
    Screen0_secure->fn->setVisible(Screen0_secure, LE_FALSE);
    Screen0_secure->fn->setBorderType(Screen0_secure, LE_WIDGET_BORDER_NONE);
    Screen0_secure->fn->setImage(Screen0_secure, (leImage*)&secure);
