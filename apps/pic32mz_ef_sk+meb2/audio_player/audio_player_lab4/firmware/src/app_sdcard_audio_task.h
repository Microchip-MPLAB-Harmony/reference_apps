...
#endif
// DOM-IGNORE-END
#define APP_SDCARD_AUDIO_CODEC_WRITE_QUEUE_SIZE    DRV_I2S_QUEUE_SIZE_IDX0
#define APP_SDCARD_AUDIO_CARD_MAX_DIRS   20
#define APP_SDCARD_AUDIO_CARD_MAX_FILES  500  

#define APP_SDCARD_AUDIO_PLAYER_QUEUE_BUFFER_SIZE (APP_SDCARD_AUDIO_CODEC_WRITE_QUEUE_SIZE-1)
...
#define APP_SDCARD_AUDIO_PLAY_LED_ON LED1_On()
#define APP_SDCARD_AUDIO_PLAY_LED_OFF LED1_Off()    
#define APP_SDCARD_AUDIO_ERROR_LED_ON LED2_On()
#define APP_SDCARD_AUDIO_ERROR_LED_OFF LED2_Off()
