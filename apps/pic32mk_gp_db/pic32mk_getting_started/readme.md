...
Refer [Project Manifest](./firmware/src/config/pic32mk_gp_db/harmony-manifest-success.yml) present in *harmony-manifest-success.yml under the project folder *firmware/src/config/{configurtion name}  
