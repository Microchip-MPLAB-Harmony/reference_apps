...
## Comments:
- Reference Guide: [Build MPLAB Harmony v3 project with ARM GCC toolchain in MPLAB X IDE](https://microchip-mplab-harmony.github.io/quick_docs/migration/build_harmony_3_project_with_gcc/readme.html)
