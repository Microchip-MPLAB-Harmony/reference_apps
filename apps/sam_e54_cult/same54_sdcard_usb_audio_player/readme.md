...
## Comments:
- This application is developed by modifying a **"drv_wm8904.c"** and **"i2s.h"** files. If you need to reconfigure or regenerate this demo using the MHC, make sure you don't replace these files. These issues are expected to be fixed in the future Harmony release.
