...
> This application uses the PORT Peripheral library to read the GPIO pin connected to the switch, and drives the GPIO pin connected to the LED1 to indicate the switch status. LED1 is turned ON when the switch is pressed and turned OFF when the switch is released.
