...
> This example application shows how to use the EVSYS Peripheral library to route the events generated by the switch to toggle an LED(LED1) on the PIC32CM LS00 Curiosity Nano+ Touch Evaluation Kit without CPU intervention.
