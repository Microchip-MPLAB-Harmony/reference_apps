...
>  The application demonstrates the DAC output is fed to an analog input for the ADC conversion. An analog input is converted by a software trigger and the converted value is displayed on the serial terminal. DAC output is changed by 0.1 V upon switch press (SW1).
