/*******************************************************************************
  ...
  Description:
    ...
    "APP_SENSOR_Initialize" and "APP_SENSOR_Tasks" prototypes) and some of them 
    are only used internally by the application (such as the "APP_SENSOR_STATES"
...
typedef enum
{
    ...
    APP_SENSOR_STATE_STORE_TEMPERATURE,                                    
