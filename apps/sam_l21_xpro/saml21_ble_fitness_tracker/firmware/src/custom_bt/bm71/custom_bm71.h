/*******************************************************************************
  ...
  Description:
    ...
    format CUSTOM_BT_xxx using #defines so that Bluetooth code in the application
    can be written as generically as possible (e.g. by writing CUSTOM_BT_Open
    instead of CUSTOM_BM71_Open etc.).
...
#ifndef CUSTOM_BM71_H
#define CUSTOM_BM71_H
...
typedef enum
{
    ...
    CUSTOM_BM71_STATUS_ON,
    CUSTOM_BM71_STATUS_READY
} CUSTOM_BM71_LIB_STATUS;         // BM64 driver status
...
typedef enum
{
    CUSTOM_BM71_BLE_STATUS_STANDBY,
    CUSTOM_BM71_BLE_STATUS_ADVERTISING,
    CUSTOM_BM71_BLE_STATUS_SCANNING,
    CUSTOM_BM71_BLE_STATUS_CONNECTED
} CUSTOM_BM71_BLE_STATUS;
...
// prototype for callback for CUSTOM_BM71_EventHandlerSet
typedef void (*CUSTOM_BM71_EVENT_HANDLER) (CUSTOM_BM71_EVENT event, uint32_t param, uintptr_t contextHandle);
...
/* Function CUSTOM_BM71_GetPowerStatus:
  ...
  Remarks:
    A status of CUSTOM_BT_STATUS_READY means the drivers state machine has finished
...
/* Function CUSTOM_BM71_TaskReq:
  ...
  Example:
    <code>
    // note generic version of call (CUSTOM_BT instead of CUSTOM_BM71) is used
    CUSTOM_BT_TaskReq(CUSTOM_BM71_REQ_SYSTEM_ON);
    </code>
  ...
  Example:
    ...
    case APP_STATE_OPEN:
    {
        if (SYS_STATUS_READY == CUSTOM_BT_Status())
        {
            ...
            if(appData.bt.handle != BM71_HANDLE_INVALID)
            {
...
void CUSTOM_BM71_EventHandlerSet(BM71_HANDLE handle,
        const CUSTOM_BM71_EVENT_HANDLER eventHandler, const uintptr_t contextHandle);
...
/* Function CUSTOM_BM71_ClearBLEData:
  ...
  Example:
    ...
    while (!CUSTOM_BT_ReadByteFromBLE(appData.bt.handle, &byte))
    {
...
/* Function CUSTOM_BM71_SendByteOverBLE:
  ...
  Example:
    ...
    // note generic version of call (CUSTOM_BT instead of CUSTOM_BM71) is used
    CUSTOM_BT_SendByteOverBLE(appData.bt.handle, byte);
    </code>
...
/* Function CUSTOM_BM71_SendDataOverBLE:
  ...
  Example:
    ...
    // note generic version of call (CUSTOM_BT instead of CUSTOM_BM71) is used
    CUSTOM_BT_SendDataOverBLE(appData.bt.handle, buf, BUFSIZE);
    </code>
...
void CUSTOM_BM71_SendDataOverBLE(const BM71_HANDLE handle, uint8_t* bytes, uint16_t size);
...
/* Function CUSTOM_BM71_BLE_EnableAdvertising:
  ...
  Example:
    <code>
    // note generic version of call (CUSTOM_BT instead of CUSTOM_BM71) is used
    CUSTOM_BM71_BLE_EnableAdvertising(appData.bt.handle, true);
    </code>
