...
********************************************************************/
#ifndef CUSTOM_BM71_LOCAL_H
#define CUSTOM_BM71_LOCAL_H
...
typedef enum
{
    CUSTOM_BM71_STATE_INITIALIZE_START = 0,
    CUSTOM_BM71_STATE_INIT_RESET_HIGH,
    CUSTOM_BM71_STATE_INIT_RESET_HIGH_WAIT,
    CUSTOM_BM71_STATE_INIT_BLE_ADV_START,
    CUSTOM_BM71_STATE_SET_BLE_ADV_PARAM,
    CUSTOM_BM71_STATE_SET_BLE_ADV_ENABLE,
    CUSTOM_BM71_STATE_BLE_ADV_WAIT,
    CUSTOM_BM71_STATE_BLE_CONNECTED,
    CUSTOM_BM71_STATE_BLE_TRANSPARENT_MODE,
    CUSTOM_BM71_STATE_BLE_DISCONNECTED,
    CUSTOM_BM71_STATE_BLE_DISCONNECTED_WAIT,
} CUSTOM_BM71_TASKSTATE;   // Bluetooth task state define
...
typedef struct _CUSTOM_BM71_OBJ_STRUCT
{
...
//    SYS_MODULE_INDEX tmrDriverModuleIndex;  // identifies control module timer ID for control interface of CODEC
    BM71_HANDLE tmrDriverHandle;     // identifies control module(Timer) driver open handle
    ...
    uint8_t linkIndex;
    uint8_t request;
//    CUSTOM_BM71_LINKSTATUS linkStatus;
//    uint8_t linkedMode;
//    uint8_t pairedRecordNumber;
    CUSTOM_BM71_TASKSTATE state;
//    CUSTOM_BM71_NEXTCOMMANDREQ nextCommandReq;
} CUSTOM_BM71_OBJ;
...
typedef struct
{
    ...
    BM71_IO_INTENT ioIntent;

    CUSTOM_BM71_PROTOCOL protocol;

    /* Call back function for this client */
    CUSTOM_BM71_EVENT_HANDLER  pEventCallBack;

    /* Client data(Event Context) that will be
     * returned at callback */
    uintptr_t hClientArg;

} CUSTOM_BM71_CLIENT_OBJ;
...
} CUSTOM_BM71_COMMON_DATA_OBJ;

// decode events (passed between custom_bm71_command_decode.c and custom_bm71.c)
typedef enum
{
    CUSTOM_BM71_DEC_EVENT_NONE = 0,

    CUSTOM_BM71_DEC_EVENT_SPP_CONNECTED,
    CUSTOM_BM71_DEC_EVENT_SPP_IAP_DISCONNECTED,

    CUSTOM_BM71_DEC_EVENT_SYS_POWER_ON,
    CUSTOM_BM71_DEC_EVENT_SYS_POWER_OFF,
    CUSTOM_BM71_DEC_EVENT_SYS_STANDBY,

    CUSTOM_BM71_DEC_EVENT_LE_STATUS_CHANGED,
    CUSTOM_BM71_DEC_EVENT_LE_ADV_CONTROL_REPORT,
    CUSTOM_BM71_DEC_EVENT_LE_CONNECTION_PARA_REPORT,
    CUSTOM_BM71_DEC_EVENT_LE_CONNECTION_PARA_UPDATE_RSP,
...
void CUSTOM_BM71_Timer1MS_event();
void CUSTOM_BM71_EventHandler(uint8_t event, uint16_t para, uint8_t* para_full);

void CUSTOM_BM71_SPPBuffClear( void );
bool CUSTOM_BM71_AddBytesToSPPBuff(uint8_t* data, uint8_t size);
void CUSTOM_BM71_UpdateClientStatus(CUSTOM_BM71_LIB_STATUS status);
#endif // CUSTOM_BM71_LOCAL_H
