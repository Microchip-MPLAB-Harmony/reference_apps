...
<span style="color:blue"> *This project has been verified to work with the following versions of software tools:*</span>  
 ...
 - ["cryptoauthlib" repo v3.3.0](https://github.com/MicrochipTech/cryptoauthlib/releases/tag/v3.3.0)
 - [MPLAB Harmony "crypto" repo v3.6.3](https://github.com/Microchip-MPLAB-Harmony/crypto/releases/tag/v3.6.3)
...
<img src = "images/hardware.jpg" align="middle">
...
- Enter the below command to set the WiFi credentials.<br>
...
- Enter a Project name as **gcp-same51-demo** and Select organization if available or select "No organization"
