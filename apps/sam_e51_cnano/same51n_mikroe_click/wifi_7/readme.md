...
<h2 align="center"> <a href="https://github.com/Microchip-MPLAB-Harmony/reference_apps/releases/latest/download/wifi_7_click.zip" > Download </a> </h2>
...
- [MPLAB Harmony v3 "wireless_wifi" repo v3.4.1](https://github.com/Microchip-MPLAB-Harmony/wireless_wifi/releases/tag/v3.4.1)
...
- Change Configuration of components as shown in the below figures
 ...
 - MHC Pin Configurator - additional pin configurations
...
- Connect the console and debug system service necessary for WINC driver as shown in the below figure
 ...
 - MHC Pin Configurator - UART pin configuration
