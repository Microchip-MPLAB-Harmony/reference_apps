...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_ImageWidget0->fn->setSize(Screen0_ImageWidget0, 96, 96);
    Screen0_ImageWidget0->fn->setBorderType(Screen0_ImageWidget0, LE_WIDGET_BORDER_NONE);
    Screen0_ImageWidget0->fn->setImage(Screen0_ImageWidget0, (leImage*)&temperature_pic);
    root0->fn->addChild(root0, (leWidget*)Screen0_ImageWidget0);

    Screen0_TextFieldWidget0 = leTextFieldWidget_New();
    Screen0_TextFieldWidget0->fn->setPosition(Screen0_TextFieldWidget0, 49, 76);
    Screen0_TextFieldWidget0->fn->setSize(Screen0_TextFieldWidget0, 37, 19);
