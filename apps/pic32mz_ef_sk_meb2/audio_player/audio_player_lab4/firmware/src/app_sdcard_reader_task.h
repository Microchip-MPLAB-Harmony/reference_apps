...
#ifndef APP_SDCARD_READER_TASK_H
#define	APP_SDCARD_READER_TASK_H
...
typedef enum
{
    APP_SDCARD_READER_STATE_INIT = 0,
    APP_SDCARD_READER_STATE_RUNNING,
...
#endif	/* APP_SDCARD_READER_TASK_H */
