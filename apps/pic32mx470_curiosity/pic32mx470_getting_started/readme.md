...
Refer [Project Manifest](./firmware/src/config/pic32mx470_curiosity/harmony-manifest-success.yml) present in harmony-manifest-success.yml under the project folder *firmware/src/config/{configurtion name}*  
