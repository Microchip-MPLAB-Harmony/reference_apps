...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_smartLabel->fn->setPosition(Screen0_smartLabel, 111, 51);
    Screen0_smartLabel->fn->setSize(Screen0_smartLabel, 256, 40);
    ...
    Screen0_smartLabel->fn->setHAlignment(Screen0_smartLabel, LE_HALIGN_CENTER);
    Screen0_smartLabel->fn->setString(Screen0_smartLabel, (leString*)&string_Title);
    root0->fn->addChild(root0, (leWidget*)Screen0_smartLabel);

    Screen0_LabelWidget_0 = leLabelWidget_New();
    Screen0_LabelWidget_0->fn->setPosition(Screen0_LabelWidget_0, 30, 195);
    Screen0_LabelWidget_0->fn->setSize(Screen0_LabelWidget_0, 115, 40);
    ...
    Screen0_LabelWidget_0->fn->setString(Screen0_LabelWidget_0, (leString*)&string_Output);
    root0->fn->addChild(root0, (leWidget*)Screen0_LabelWidget_0);

    Screen0_LabelWidget_1 = leLabelWidget_New();
    Screen0_LabelWidget_1->fn->setPosition(Screen0_LabelWidget_1, 150, 195);
    Screen0_LabelWidget_1->fn->setSize(Screen0_LabelWidget_1, 300, 40);
