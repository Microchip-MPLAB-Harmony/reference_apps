...
path = os.getcwd() + "\\samd21_aws_iot_v2_winc_provisioning"
samioturl = 'https://github.com/Microchip-MPLAB-Harmony/reference_apps/releases/latest/download/samd21_aws_iot_v2_winc_provisioning.zip'
